...
\begin{itemize}
    \item przez czujnik, którego odczyt przebił próg detekcji (CO\textsubscript{2} $> 800$ ppm, PM2.5 $> 100$ µg/m³, temperatura $> 45$ °C lub kamera wykryła dym), albo
    \item przez patrol leśników znajdujący się w pobliżu płonącego sektora.
\end{itemize}
...
\begin{enumerate}
    \item \textbf{Filtrowanie:} Ignorowane są sektory z aktywnym pożarem (stan \texttt{BURNING})
